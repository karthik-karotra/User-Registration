...
public class UserRegistration {
    ...
    static String VALID_PASSWORD_WITH_ATLEAST_ONE_UPPERCASE_PATTERN= "^(?=.*[A-Z])[a-zA-Z]{8,}$";
    static String VALID_PASSWORD_WITH_ATLEAST_ONE_NUMERIC_PATTERN="^(?=.*[A-Z])(?=.*[0-9])[a-zA-Z0-9]{8,}$";
    static String VALID_PASSWORD_WITH_EXACTLY_ONE_SPECAIL_CHARACTER_PATTERN="^((?=[^@|#|&|%|!|$]*[@|#|&|%|!|$][^@|#|&|%|!|$]*$)(?=.*[A-Z])(?=.*[0-9])[A-Za-z0-9@#&%!$]{8,})$";
